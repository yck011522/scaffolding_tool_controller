...
- Run started: 2026-05-11T12:27:37
- USB port:   `COM22`
- RS-485 port: `COM7`
- Baud:        115200
...
[GROUP] Motor exercise — using FACTORY DEFAULTS (USB-CDC)
  ...
  [PASS] STATUS during TIGHTEN M1 parses  — got: 'OK TIGHTENING IDLE 72 62'
  [PASS] TIGHTEN M1: motor state == TIGHTENING  — got M1=TIGHTENING M2=IDLE
  [PASS] TIGHTEN M1: current > 0 mA  — got 72 mA
  ...
  [PASS] STATUS during LOOSEN M1 parses  — got: 'OK LOOSENING IDLE 82 62'
  [PASS] LOOSEN M1: motor state == LOOSENING  — got M1=LOOSENING M2=IDLE
  [PASS] LOOSEN M1: current > 0 mA  — got 82 mA
  ...
  [PASS] STATUS during TIGHTEN M2 parses  — got: 'OK IDLE TIGHTENING 87 62'
  [PASS] TIGHTEN M2: motor state == TIGHTENING  — got M1=IDLE M2=TIGHTENING
  [PASS] TIGHTEN M2: current > 0 mA  — got 87 mA
  ...
  [PASS] STATUS during LOOSEN M2 parses  — got: 'OK IDLE LOOSENING 84 62'
  [PASS] LOOSEN M2: motor state == LOOSENING  — got M1=IDLE M2=LOOSENING
  [PASS] LOOSEN M2: current > 0 mA  — got 84 mA
...
[GROUP] STATUS (RS-485)
  [PASS] STATUS matches '<s1> <s2> <mA> <pwm%>'  — got: 'OK IDLE IDLE 2 0'
...
[GROUP] Motor exercise — using FACTORY DEFAULTS (RS-485)
  [PASS] TIGHTEN M1 accepted  — got: 'OK TIGHTEN M1'
  [PASS] STATUS during TIGHTEN M1 parses  — got: 'OK TIGHTENING IDLE 88 62'
  [PASS] TIGHTEN M1: motor state == TIGHTENING  — got M1=TIGHTENING M2=IDLE
  [PASS] TIGHTEN M1: current > 0 mA  — got 88 mA
  [PASS] TIGHTEN M1: pwm > 0 %  — got 62 %
  [PASS] STOP after TIGHTEN M1  — got: 'OK STOP'
  ...
  [PASS] TIGHTEN M1: pwm == 0 after STOP  — got 0 %
  [PASS] LOOSEN M1 accepted  — got: 'OK LOOSEN M1'
  [PASS] STATUS during LOOSEN M1 parses  — got: 'OK LOOSENING IDLE 62 62'
  [PASS] LOOSEN M1: motor state == LOOSENING  — got M1=LOOSENING M2=IDLE
  [PASS] LOOSEN M1: current > 0 mA  — got 62 mA
  [PASS] LOOSEN M1: pwm > 0 %  — got 62 %
  [PASS] STOP after LOOSEN M1  — got: 'OK STOP'
  ...
  [PASS] LOOSEN M2: pwm > 0 %  — got 62 %
  [PASS] STOP after LOOSEN M2  — got: 'OK STOP'
  [PASS] STATUS after STOP parses  — got: 'OK IDLE IDLE 4 0'
  [PASS] LOOSEN M2: motor returned to IDLE  — got M1=IDLE M2=IDLE
  [PASS] LOOSEN M2: pwm == 0 after STOP  — got 0 %
