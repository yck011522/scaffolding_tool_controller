...
const int PWM_MAX_M1_TIGHTEN = 160;  // max output PWM for M1 tighten - avoid sudden current spike shwn tightening
const int PWM_MAX_M1_LOOSEN = 160;   // max output PWM for M1 loosen
const int PWM_MAX_M2_TIGHTEN = 160;  // max output PWM for M2 tighten
const int PWM_MAX_M2_LOOSEN = 160;   // max output PWM for M2 loosen
...
unsigned long rampDurationMs = 200;   // soft-start ramp from startup PWM to configured max PWM
